...
function Navbar() {
    ...
    const { user, Logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userStore"])();
    const logoutHandler = ()=>{
        Logout();
        rout.push("/");
    };
...
_s(Navbar, "Eg2miL+LGbm/LV0GEC9+m/RM+wU=", false, function() {
    return [
...
//# sourceMappingURL=src_3e0b1ff7._.js.map